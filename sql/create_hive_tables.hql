...
CREATE EXTERNAL TABLE weather (
	...
	snow_depth_mm INT COMMENT 'Snow depth (mm)',
	snowfall_mm INT COMMENT 'Snowfall (mm)',
	...
	avg_wind_speed INT COMMENT 'Average daily wind speed (tenths of meters per second)',
	...
	blowing_dust INT COMMENT 'Ash, dust, sand, or other blowing obstruction',
	fog INT COMMENT 'Fog, ice fog, or freezing fog (may include heavy fog)',
	rain INT COMMENT 'Rain or snow shower',
	thunder INT COMMENT 'Thunder',
	WT09 INT COMMENT 'Blowing or drifting snow',
	drizzle INT COMMENT 'Drizzle',
	WT07 INT COMMENT 'Dust, volcanic ash, blowing dust, blowing sand, or blowing obstruction',
	fog2 INT COMMENT 'Fog, ice fog, or freezing fog (may include heavy fog)',
	frz_drizzle INT COMMENT 'Freezing drizzle ',
	frz_rain INT COMMENT 'Freezing rain ',
	WT06 INT COMMENT 'Glaze or rime ',
	WT21 INT COMMENT 'Ground fog ',
	hail INT COMMENT 'Hail (may include small hail)',
	...
	ice_fog INT COMMENT 'Ice fog or freezing fog',
	WT04 INT COMMENT 'Ice pellets, sleet, snow pellets, or small hail',
	mist INT COMMENT 'Mist',
	...
	tornado INT COMMENT 'Tornado, waterspout, or funnel cloud',
